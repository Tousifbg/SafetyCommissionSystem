...
import com.example.publicsafetycomission.Profile;
...
public class DistrictAdapter3 extends RecyclerView.Adapter<DistrictAdapter3.ViewHolder>
    ...
    public DistrictAdapter3(Context mContext, List<DistrictModel> districtModels, Dialog dialog) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                ((Profile) mContext).recyclerTouchMethod(districtMod.getDistrict_id(),
